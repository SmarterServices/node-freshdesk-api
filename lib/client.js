...
Freshdesk.prototype = Object.create({
   ...
   */
	getRequest(url, query, callback) {
		makeRequest('GET', this._auth, this.baseUrl + url, query, null, callback);
	},
   ...
   */
	postRequest(url, query, data, callback) {
		makeRequest('POST', this._auth, this.baseUrl + url, query, data, callback);
	},
   ...
   */
	putRequest(url, query, data, callback) {
		makeRequest('PUT', this._auth, this.baseUrl + url, query, data, callback);
	},
   ...
   */
	deleteRequest(url, query, data, callback) {
		makeRequest('DELETE', this._auth, this.baseUrl + url, query, data, callback);
	},
